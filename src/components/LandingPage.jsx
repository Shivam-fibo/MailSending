...
export default function BulkEmailLanding() {
  ...
  return (
    <div className="min-h-screen ">
      ...
      {/* Hero Section */}
      <section className="relative px-6 py-20 lg:py-10">
          ...
          <div>
            <div className="mb-2">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight">
                Send Bulk Emails
                <span className='bg-blue-500 text-white rounded-xl px-2 mx-2'>with Ease</span>
              </h1>
              <p className="text-xl lg:text-2xl text-gray-600  max-w-3xl mx-auto leading-relaxed">
                The fastest way to deliver mail in bulk
              </p>
              <Link to="/login">
              <button className=" text-black my-4 border px-8 py-4 rounded-2xl text-lg font-semibold inline-flex items-center gap-2">
              ...
              <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20 max-w-4xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                  ...
                  <div className="flex justify-center">
                    <div className="w-16 h-1rounded-full"></div>
                  </div>
            ...
            <div delay={200}>
              <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl">
                <div className="text-center">
                  ...
                  <div className="text-gray-600 mb-6">per email sent</div>
